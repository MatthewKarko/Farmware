...
ALLOWED_HOSTS = ['.localhost', '127.0.0.1', '[::1]', 'ec2-44-202-160-13.compute-1.amazonaws.com']
...
NOSE_ARGS = [
    '--with-coverage',
    '--cover-package=core.api.models,core.api.viewsets,core.user.models,core.user.viewsets',
    '--cover-html',
]