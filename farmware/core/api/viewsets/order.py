...
class OrderViewSet(ModelViewSet):
    ...
    RESPONSE_CREATION_SUCCESS = Response({'success': 'Order created.'}, status=status.HTTP_200_OK)
    RESPONSE_DELETION_SUCCESS = Response({'success': 'Order deleted.'}, status=status.HTTP_200_OK)
